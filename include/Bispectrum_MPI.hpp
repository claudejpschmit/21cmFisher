...
class Bispectrum {
    ...
    public:
         ...
         *
         */
        Bispectrum(AnalysisInterface *analysis, MPI_Comm communicator);
        ...
        vector<double> give_interp_theta_vals(int li, int lj, int q, int Pk_i, int Tb_i, int q_i,\
                double zc_max, double zc_min, double delta_zc);
        vector<Theta> make_interps(int l, int size, double* vals, double zc_max, double zc_min, double delta_zc);
